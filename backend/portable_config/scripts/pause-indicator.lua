...
local options = {
    ...
    icon_opacity = 50,               -- icon opacity (0-100)
...
local function draw_rectangles()
    return string.format([[{\an5\p1\alpha&H%s\1c&H%s&\bord0\shad0}m 0 0 l %d 0 l %d %d l 0 %d m %d 0 l %d 0 l %d %d l %d %d]],
        icon_opacity, icon_color, options.rectangles_width, options.rectangles_width, options.rectangles_height, options.rectangles_height,
...
local function draw_triangle()
    return string.format([[{\an5\p1\alpha&H%s\1c&H%s&\bord0\shad0}m 0 0 l %d %d l 0 %d]], 
        icon_opacity, icon_color, options.triangle_width, options.triangle_height / 2, options.triangle_height)
end
